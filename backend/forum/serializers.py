...
class SinglePostSerializer(serializers.ModelSerializer):
    #Used to return users name, profile pic, comments and likes under a single post
    user = serializers.SerializerMethodField()
    profile_picture = serializers.SerializerMethodField()
    ...
    #Returns likes, comments, profile pic, and user
...
#Validation for user password reset
...
#Validation for student role user
...
#Validation for faculty role user
...
#Validaiton for likes
class LikeSerializer(serializers.ModelSerializer):
    class Meta:
        model = Likes
        fields = "__all__"

#Validation for saving posts
